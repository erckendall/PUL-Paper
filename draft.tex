...
While the user is encouraged validate their choice of timestep through convergence testing on a case-by-case basis, \PyUltraLight does include a default timestep value which is chosen based on maximum fluid velocity arguments. In the fluid interpretation of the Schr{\"o}dinger-Poisson system, we define
