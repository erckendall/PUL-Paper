...
The existence of an extremely light scalar field, minimally coupled to gravity, is the central premise on which ULDM models are predicated. Within the ULDM framework, it is proposed that cosmological structure formation proceeds through the Bose-Einstein condensation of this scalar field. In this Section  \re{I would normally give Section a capital letter in this context} \re{(EK) I would be inclined to only capitalise `section' in instances where it appears as a proper noun, i.e. "In Section X we showed...", where we are referring to a specifically named section, numbered X. It seems to me that in this particular context `section' is a common noun. Happy to capitalise all instances of the word if this is your recommendation.} we derive the (non-relativistic) dynamical equations of the single macroscopic condensate wavefunction, namely, the Schr{\"o}dinger-Poisson equations. We begin with the action functional for a scalar field, $\phi$, minimally coupled to gravity and in the absence of self-interactions,
%
...
In addition to the evolution of the condensate wavefunction $\psi$ and the potential $\Phi$, \PyUltraLight also evaluates the energy of the Schr{\"o}dinger-Poisson system. An important achievement of the code is sub-percent level energy conservation, even at relatively low spatial resolution, for all dynamical scenarios tested. In this section we derive the expression for the total energy of the Schr{\"o}dinger-Poisson system and discuss its decomposition into individual constituents calculated separately within the code. We then present the numerical energy evolution of a variety of configurations. 
