...
\includegraphics{interference_patterns}
...
\caption{Head-on collisions between two solitons of mass 5, relative velocity 6, and initial separation 4 in code units. Time progresses from left to right across each row.}\label{fig:repulsion}
\end{figure}



% \subsection{Soliton Mergers}

% Want to show radial profile looking like NFW at the outer edges. See http://zulassung.hlrn.de/kurzbeschreibungen/nip00040.pdf
